...
from task.loader_nfar import NFarthestData, NFarthest

FLAGS = tf.flags.FLAGS

# Model parameters
tf.flags.DEFINE_integer("hidden_size", 1024, "Size of LSTM hidden layer.")
tf.flags.DEFINE_integer("memory_address_size", 16, "The number of memory slots.")
tf.flags.DEFINE_integer("memory_length_size", 128, "The width of each memory slot.")
...
# Training options.
tf.flags.DEFINE_integer("batch_size", 1600, "Batch size for training.")
tf.flags.DEFINE_integer("epoch", 1, "Number of epochs to train for.")
tf.flags.DEFINE_integer("summarize", 100, "Interval for summarize.")
...
tf.flags.DEFINE_integer("checkpoint_interval", 1000, "Checkpointing step interval.")
tf.flags.DEFINE_string("name", "nfar", "Name of training model.")
